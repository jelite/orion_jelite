...
train_batch=(64)
infer_batch=(8)
train=("densenet121" "resnet50" "mobilenet_v3_large" "efficientnet_v2_m" "vit_b_16" "swin_b")
infer=("densenet121" "resnet50" "mobilenet_v3_large" "efficientnet_v2_m" "vit_b_16" "swin_b")
base_rps=(19.71 28.35 106.81 13.84 30.67 21.61)
dist_method=("poisson")
