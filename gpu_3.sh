...
/usr/bin/python3.8 run_ncu.py --model_name "vit_b_16" --batch_size 8 --gpu_num 1 
/usr/bin/python3.8 run_ncu.py --model_name "vit_b_16" --batch_size 1 --gpu_num 1 --do_infer
